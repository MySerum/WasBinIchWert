// WasBinIchWert v8.44 – lokaler Safari-/Offline-kompatibler pdf-lib Loader
(function initPdfLibLoader(){
  if(window.loadPdfLib)return;
  const SRC='./vendor/pdf-lib.min.js';
  let pending=null;
  ...
  window.loadPdfLib=function(){
    ...
    pending=new Promise((resolve,reject)=>{
      ...
      script.onerror=()=>reject(new Error('Lokales PDF-Modul konnte nicht geladen werden.'));
